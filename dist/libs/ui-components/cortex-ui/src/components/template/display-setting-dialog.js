...
import '../kit/dialog';
let DisplaySettingDialog = class DisplaySettingDialog extends LitElement {
    constructor() {
        super(...arguments);
    ...
    render() {
      ...
      <c-dialog
        ...
        padding="30px 0"
        zIndex="${this.zIndex}"
        @status="${(e) => this.setDisplayDialog(e)}"
          ...
          <c-wrap type="fluid" mt="12px">
            ...
            <div class="section">
              ...
              <c-wrap d="flex" justify="space-between" mt="16px">
                ${this.bgTheme.map(({ text, value, checked }, index) => html `
            ...
            <div class="section">
              ...
              <c-wrap d="flex" justify="space-around" mt="16px">
                ${this.colorTheme.map(({ palette, value, checked, text }) => html `
            ...
            <div class="section">
              ...
              <div class="font-theme-wrapper">
                ...
                ${this.fontTheme.map(({ checked, value }, index) => html `
                    <c-radio
    ...
    setDisplayDialog(e) {
        ...
        this.dispatchEvent(new CustomEvent('displayDialogClose', {
            detail: {
                open: false,
            },
            bubbles: true,
    ...
    changeTheme(theme, bgIndex, colorIndex = 0, fontIndex = 0) {
...
], DisplaySettingDialog.prototype, "colorTheme", void 0);
__decorate([
    state(),
    __metadata("design:type", Object)
], DisplaySettingDialog.prototype, "bgTheme", void 0);
__decorate([
    property({
        type: Object,
    }),
    __metadata("design:type", Object)
], DisplaySettingDialog.prototype, "displayDialog", void 0);
__decorate([
    state(),
    __metadata("design:type", Array)
], DisplaySettingDialog.prototype, "bgThemeClassName", void 0);
__decorate([
    property(),
    __metadata("design:type", Object)
], DisplaySettingDialog.prototype, "zIndex", void 0);
__decorate([
    state(),
    __metadata("design:type", Object)
], DisplaySettingDialog.prototype, "fontTheme", void 0);
DisplaySettingDialog = __decorate([
    customElement('c-display-setting-dialog')
], DisplaySettingDialog);
export { DisplaySettingDialog };
//# sourceMappingURL=display-setting-dialog.js.map