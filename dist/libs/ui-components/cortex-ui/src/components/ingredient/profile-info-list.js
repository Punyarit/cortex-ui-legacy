...
import './image';
import './profile';
let ProfileInfoList = class ProfileInfoList extends LitElement {
    constructor() {
        super(...arguments);
        this.hidePatientForm = false;
        this.info = [];
    }
    render() {
        return html `
...
], ProfileInfoList.prototype, "hidePatientForm", void 0);
__decorate([
    property({ type: Array }),
    __metadata("design:type", Array)
], ProfileInfoList.prototype, "info", void 0);
ProfileInfoList = __decorate([
