...
import '../../kit/content';
let EncounterTimelineSkeleton = class EncounterTimelineSkeleton extends LitElement {
    render() {
        return html `
      <c-content>
        ...
        <c-wrap mt="22px">
          <c-wrap d="flex" justify="center" colGap="60px">
            ${[1, 2, 3, 4, 5].map(() => html ` <c-wrap d="flex" layout="column" rowGap="12px" aligns="center">
...
EncounterTimelineSkeleton.styles = css ``;
EncounterTimelineSkeleton = __decorate([
    customElement('c-encounter-timeline-skeleton')
], EncounterTimelineSkeleton);
export { EncounterTimelineSkeleton };
//# sourceMappingURL=encounter-timeline-skeleton.js.map