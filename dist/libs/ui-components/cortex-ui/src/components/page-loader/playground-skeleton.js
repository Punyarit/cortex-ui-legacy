...
import '../kit/wrap';
let PlaygroundSkeleton = class PlaygroundSkeleton extends LitElement {
    render() {
        return html `
      ...
      <c-wrap mt="112px">
        ${[1, 0.8, 0.6, 0.4].map(opacity => html `
            <c-wrap mt="12px">
...
PlaygroundSkeleton = __decorate([
    customElement('c-playground-skeleton')
], PlaygroundSkeleton);
export { PlaygroundSkeleton };
//# sourceMappingURL=playground-skeleton.js.map